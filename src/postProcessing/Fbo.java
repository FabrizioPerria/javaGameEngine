...
public class Fbo {
	...
	public void unbindFrameBuffer() {
		...
		GL11.glViewport(0, 0, 2*DisplayManager.getWindowWidth(), 2*DisplayManager.getWindowHeight());
	}
	...
	private void initialiseFrameBuffer(int type) {
		...
		if(multisampleAndMultiTarget){
			colourBuffer = createMultisampleColorBufferAttachment(GL30.GL_COLOR_ATTACHMENT0);
			colourBuffer2 = createMultisampleColorBufferAttachment(GL30.GL_COLOR_ATTACHMENT1);
		}else{
	...
	public void resolveToFBO(int readBuffer, Fbo outFBO){
	...
	public void resolveToScreen(){
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, DisplayManager.getWindowWidth(), DisplayManager.getWindowHeight(), GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
	...
	private int createMultisampleColorBufferAttachment(int attachment) {
