...
public class ParticleInstancedSystem {
    ...
    public ParticleInstancedSystem(ParticleInstancedTexture texture, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
    	this.texture = texture;
		this.pps = Math.min(pps, ParticleInstancedRenderer.MAX_INSTANCES);
